...
declare function connect<TStateProps = {}, no_dispatch = {}, TOwnProps = {}, State = {}>(
	this: void,
...
declare function connect<no_state = {}, TDispatchProps = {}, TOwnProps = {}>(
	...
	mapDispatchToProps: RoactRodux.MapDispatchToPropsNonObject<TDispatchProps, TOwnProps>,
): RoactRodux.EnhancerWithProps<TDispatchProps, TOwnProps>;
declare function connect<TStateProps = {}, TDispatchProps = {}, TOwnProps = {}, State = {}>(
	this: void,
